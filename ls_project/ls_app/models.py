...
class beats(models.Model):
    ...
    artwork = models.ImageField(upload_to ='/home/TakudzwaChikanga/mbidho/ls_project/ls_app/media',help_text="Upload artwork")
    the_file = models.FileField(upload_to ='/home/TakudzwaChikanga/mbidho/ls_project/ls_app/media',help_text="Upload beat")
